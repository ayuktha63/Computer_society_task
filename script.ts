...
function createTypewriterEffect(elementId: string, texts: string[]) {
  const element = document.getElementById(elementId) as HTMLDivElement; // Cast to HTMLDivElement
...
document.addEventListener("DOMContentLoaded", () => {
  const csiImage = document.getElementById("csiImage") as HTMLImageElement;
